...
| **[offset](https://github.com/mathmati/FreeCAD-Offset)** | Click a planar face and drag (or type a distance) to offset its boundary in its own plane, SketchUp style. Produces the inner face and ring, ready for Push/Pull. [**beta - live for initial discussion and feedback**] |
| **[follow-me](https://github.com/mathmati/FreeCAD-FollowMe)** | Sweep a profile face along an edge or chain of edges, like SketchUp's Follow Me: click the face, click the path, press Enter. [**beta - live for initial discussion and feedback**] |

...
(`Standard/Metal/Steel/`, `Standard/Metal/Aluminum/`, etc. — see
`../../../FORMAT.md` §1). All files named `EngSTD-*.FCMat` are this
...
See `../../../SOURCES.md` for the sourcing/licensing plan and
`../../../DATA_PROVENANCE.md` for the accuracy-gate record.
